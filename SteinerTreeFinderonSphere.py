...
#steinerTree((((1, 0,0), (0.5, 0.8660254037844386,2), (-0.5, 0.8660254037844387,0), (-1,0,2),(-0.5,-0.8660254037844384,0), (0.5,-0.8660254037844386,2))))
...
steinerTree(nodes)
#n=3
#nodes = [((radius,2*np.pi*random.uniform(0,1),np.pi*random.uniform(-1,1)/2) for i in range(n))]
#print(nodes)
#steinerTree(nodes)
